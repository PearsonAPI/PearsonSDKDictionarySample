$(function() {
    ...
    // Load the Pearson Dicitionaris API. Note that you pass you apikey into this method if 
    // you have one. If no apikey is specified, the sample will default to using the dictionary
    // 'sandbox' (only shows words beigining with the letters 'a' through 'c')
    //
    //    var dict = PearsonApis.dictionaries("my_api_key"); 
    //
    
    var dict = PearsonApis.dictionaries(); // optional - add your apikey in here
