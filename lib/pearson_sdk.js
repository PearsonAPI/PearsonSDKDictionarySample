...
function Pearson(apiKey) {
    ...
    if (typeof apiKey === 'undefined') {
        this.base = 'http://api.pearson.com/';
    } else {
        this.base = 'http://api.pearson.com/';
        //this.apiKey = "&apikey=" + apiKey;
        this.apiKey = apiKey;
    }
    console.log("Pearson => ",this)
    return this;
}

Pearson.prototype.getURL = function() {
    return this.base
}

function Api(sdk,path) {
    this.sdk = sdk;
    this.path = path;
    return this;
}
...
Api.prototype.getURL = function() {
    return this.sdk.getURL() + this.path
}
...
Pearson.prototype.dictionaries = function() {
    var dict = new Api(this,"v2/dictionaries");
    dict.entries = new Endpoint(dict,"/entries")
    return dict
}
